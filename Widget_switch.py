...
class windowLayout(QWidget):
    def __init__(self, parent):
        ...
        self.ButtonLayout.addLayout(self.button_5.layout, 1, 4) 
        self.ButtonLayout.addLayout(self.button_6.layout, 2, 0) 
        self.ButtonLayout.addLayout(self.button_7.layout, 2, 1) 
        self.ButtonLayout.addLayout(self.button_8.layout, 2, 2) 
        self.ButtonLayout.addLayout(self.button_9.layout, 2, 3) 
        self.ButtonLayout.addLayout(self.button_10.layout, 2, 4) 
        self.ButtonLayout.addLayout(self.button_11.layout, 3, 0) 
        self.ButtonLayout.addLayout(self.button_12.layout, 3, 1) 
        self.ButtonLayout.addLayout(self.button_13.layout, 3, 2) 
        self.ButtonLayout.addLayout(self.button_14.layout, 3, 3) 
        self.ButtonLayout.addLayout(self.button_15.layout, 3, 4) 
        self.ButtonLayout.addLayout(self.button_16.layout, 4, 0) 
        self.ButtonLayout.addLayout(self.button_17.layout, 4, 1) 
        self.ButtonLayout.addLayout(self.button_18.layout, 4, 2) 
        self.ButtonLayout.addLayout(self.button_19.layout, 4, 3) 
